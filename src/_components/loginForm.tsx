        ...
        {providers.includes("credentials") && (
          <>
            <div className="flex flex-col gap-4">
              {!isLogin && (
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="rounded-md w-full h-8 border border-gray-300 focus:outline-blue-500 p-2"
                  />
                </div>
              )}
              <div className="flex flex-col gap-2">
              ...
              <button
                ref={buttonRef}
                className="px-8 h-10 rounded-md bg-blue-500 text-white hover:scale-105 transition-all duration-300 cursor-pointer"
          ...
          {providers
            ...
            .map((provider) => (
              <button
                ...
                className="h-10 rounded-md cursor-pointer bg-white text-black border border-gray-300 flex gap-2 items-center justify-center hover:scale-105 transition-all duration-300"
              >
